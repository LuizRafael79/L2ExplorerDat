...
public class JPopupTextArea extends JTextArea
{
	...
	protected void goToLine()
	{
		...
		if (lineno != null)
		{
			...
			else
			{
				...
				{
					JOptionPane.showMessageDialog(new Frame(), "Bad position", "Error", JOptionPane.ERROR_MESSAGE);
				}
			}
		}
	}
	...
	protected void searchString()
	{
		...
		{
			JOptionPane.showMessageDialog(new Frame(), "Enter a empty string", "Error", JOptionPane.ERROR_MESSAGE);
			return;
		}
